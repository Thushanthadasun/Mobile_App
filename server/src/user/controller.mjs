...
export const loginUser = async (req, res) => {
  try {
    ...
    //if (!user.isotpverified) {                                                            // mobile verification temparaly comment out 
    ...
    <body>
      <div class="container">
        ...
        <div style="text-align: center;">
          <a href="http://localhost:5000/api/v1/user/emailverify?token=${token}" class="btn">Click here to verify</a>

        </div>
        <p style="margin-top: 25px;">If the button doesn't work, you can also copy and paste the following link into your browser:</p>
      <p style="font-size: 14px;">http://localhost:5000/api/v1/user/emailverify?token=${token}</p>
      </div>
      <div class="footer">
