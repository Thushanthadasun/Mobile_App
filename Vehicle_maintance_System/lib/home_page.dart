...
class _VehicleRegistrationPageState extends State<VehicleRegistrationPage> {
  ...
  final List<String> _statusOptions = ['Active', 'Inactive', 'Sold'];
  final List<String> _fuelOptions = ['Petrol', 'Diesel', 'Electric', 'Hybrid'];
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      // Store the vehicle details (e.g., send to a backend or local storage)
      ...
      print('Vehicle Details: $vehicleDetails'); // Replace with actual storage logic
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Make Year'),
              ...
              DropdownButtonFormField<String>(
                ...
                items: _fuelOptions.map((String value) {
                  return DropdownMenuItem(
                    value: value,
                    child: Text(value),
                  );
